							...
							<div class="row g-0">
								...
								<div class="col-md-6 col-lg-7 d-flex align-items-center">
									<div class="card-body p-4 p-lg-5 text-black">
											<h3 class="mb-5">Ooops!!!!!!<br>Something went wrong retry</h3>
										<form action="successLogin" method="post">
											...
											<div class="form-outline mb-4">
												<input type="text" id="loginEmail" name="loginEmail"
													...
													class="form-label" for="loginEmail">User Email</label>
											</div>
											...
											<p class="mb-5 pb-lg-2" style="color: #393f81;">
												Don't have an account? <a href="registration" style="color: #393f81;">Register
													here</a>
											</p>
